...
//= require jquery-bootstrap-scrolling-tabs/jquery.scrolling-tabs
...
//= require datatables-plugins/pagination/ellipses
//= require wait-me/dist/waitMe.min
//= require jquery_ujs
//= require moment
//= require eonasdan-bootstrap-datetimepicker
//= require validator/js/bootstrapValidator
    ...
    return {
        render: function () {
            ...
            if (typeof App.landing !== 'undefined' && App.landing) {
                ...
                var avatar = '/images/img/no-avatar.png';
                var partyName = '';
                    ...
                    if (basicProfileDropzone.getQueuedFiles().length > 0) {
                        ...
                        $.ajax({
                            ...
                            if (response.success) {
                                ...
                                if (response.logo === "") {
                                    response.logo = '/images/img/no-avatar.png';
                                }
